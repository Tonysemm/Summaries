...
export class UpdateBookComponent implements OnInit {
  ...
  ngOnInit() {
    this.service.getBookById(this.route.snapshot.params.id).subscribe((data: Book) => {
  ...
  onSubmit() {
    this.service.updateBook(this.updateBookForm.value).subscribe(() => this.router.navigate(['/books']));
  }
}
